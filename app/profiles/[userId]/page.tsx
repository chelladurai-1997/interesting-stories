    ...
    <div className="p-6 space-y-4">
      ...
      >
        <div className="space-y-2 text-gray-800">
          ...
          <p>
            <strong>Marital Status:</strong> {profile.basicInfo.marital_status}
          </p>
          <p>
      ...
      >
        <div className="space-y-2 text-gray-800">
          <p>
            <strong>Education:</strong> {profile.educationOccupation.education}
          </p>
          <p>
      ...
      >
        <div className="space-y-2 text-gray-800">
          ...
          <p>
            <strong>Working Place:</strong> {profile.expectations.working_place}
          </p>
          <p>
      ...
      >
        <div className="space-y-2 text-gray-800">
          ...
          <p>
            <strong>Father Status:</strong> {profile.familyDetails.fatherStatus}
          </p>
          <p>
            <strong>Mother's Name:</strong> {profile.familyDetails.motherName}
          </p>
          <p>
            <strong>Mother Status:</strong> {profile.familyDetails.motherStatus}
          </p>
          <p>
          ...
          <p>
            <strong>Mother's Kulam:</strong> {profile.familyDetails.motherKulam}
          </p>
          <p>
      ...
      >
        <div className="space-y-2 text-gray-800">
          ...
          <p>
            <strong>Kula Deivam:</strong> {profile.personalDetails.kula_deivam}
          </p>
          <p>
          ...
          <p>
            <strong>Blood Group:</strong> {profile.personalDetails.blood_group}
          </p>
          <p>
